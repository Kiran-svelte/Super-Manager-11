...
def patch():
    old_store = open('backend/core/integration_manager/integration_store.py').read()
...
"""
        ...
        open('backend/core/integration_manager/integration_store.py', 'w', encoding='utf-8').write(new_store)
